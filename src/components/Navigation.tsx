...
export const Navigation = () => {
  return (
    <div className="space-y-5 font-normal text-md pr-8 text-gray-900">
      ...
      <Link icon={home} name="Home" path="/" />
      <Link icon={explore} name="Explore" path="/explore" />
      <Link icon={message} name="Messages" path="/messages" />
      <Link icon={user} name="Profile" path="/profile" />
